...
export class ApiClient {
    constructor() {
         ...
         * @type {String}
         * @default https://virtserver.swaggerhub.com/designing-apis/part-one/ch08-end
         */
        this.basePath = 'https://virtserver.swaggerhub.com/designing-apis/part-one/ch08-end'.replace(/\/+$/, '');
        ...
        this.authentications = {
            'MyUserToken': {type: 'apiKey', 'in': 'header', name: 'Authorization'}
        }
