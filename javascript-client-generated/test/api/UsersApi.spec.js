...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FarmStallApi.UsersApi();
  });
    ...
    describe('UsersApi', function() {
      describe('tokensPost', function() {
        it('should call tokensPost successfully', function(done) {
          // TODO: uncomment, update parameter values for tokensPost call and complete the assertions
          /*
          var opts = {};

          instance.tokensPost(opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(FarmStallApi.InlineResponse2012);
      ...
      describe('usersPost', function() {
        it('should call usersPost successfully', function(done) {
          ...
          instance.usersPost(opts, function(error, data, response) {
            ...
            // TODO: update response assertions
            expect(data).to.be.a(FarmStallApi.InlineResponse2011);
