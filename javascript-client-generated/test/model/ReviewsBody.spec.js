...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ReviewsBody', function() {
      beforeEach(function() {
        instance = new FarmStallApi.ReviewsBody();
      });

      it('should create an instance of ReviewsBody', function() {
        // TODO: update the code to test ReviewsBody
        expect(instance).to.be.a(FarmStallApi.ReviewsBody);
      });
